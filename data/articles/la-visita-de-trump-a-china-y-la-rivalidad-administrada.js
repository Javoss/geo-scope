export const articleLaVisitaDeTrumpAChinaYLaRivalidadAdministrada = {
  slug: "la-visita-de-trump-a-china-y-la-rivalidad-administrada",
  title:
    "Trump en Beijing: la rivalidad que nadie puede ganar, pero todos necesitan administrar",
  subtitle:
    "La visita mostró que la relación entre Estados Unidos y China ya no se negocia solo entre diplomáticos: también participan CEOs, bancos, tecnológicas, energéticas, cadenas industriales y potencias que buscan redefinir el orden global.",
  excerpt:
    "La visita a Beijing no resolvió la competencia estructural entre Washington y China. Mostró, en cambio, que la relación más importante del sistema internacional necesita canales de gestión incluso cuando se disputa tecnología, comercio, seguridad y legitimidad global.",
  type: "analysis",
  region: "global",
  sectors: ["geopolitica", "china-estados-unidos", "diplomacia"],
  ...
  bodySections: [
    ...
    {
      heading: "La trampa de Tucídides y el riesgo de fondo",
      paragraphs: [
    ...
    {
      heading: "La diplomacia del símbolo: cómo China recibió a Trump",
      paragraphs: [
      ...
      callouts: ["China no solo negoció con palabras. Negoció con símbolos."],
    },
    {
      heading: "Una cumbre diplomática con rostro empresarial",
      paragraphs: [
    ...
    {
      heading: "Tecnología y CEOs: los términos reales de la negociación",
      paragraphs: [
    ...
    {
      heading: "¿Quién ganó realmente la visita?",
      paragraphs: [
    ...
    {
      heading: "La narrativa china: estabilidad, paridad y control del mensaje",
      paragraphs: [
    ...
    {
      heading: "La narrativa estadounidense: acceso, resultados y presión",
      paragraphs: [
    ...
    {
      heading: "Taiwán: el límite de cualquier estabilización",
      paragraphs: [
    ...
    {
      heading: "Irán: China como mediador necesario, pero cauteloso",
      paragraphs: [
    ...
    {
      heading: "Rusia, Putin y la dimensión triangular",
      paragraphs: [
    ...
    {
      heading: "Comercio y mercados: alivio parcial, incertidumbre estructural",
      paragraphs: [
    ...
    {
      heading: "América Latina, BRICS y Sur Global",
      paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        {
          heading: "1. Competencia administrada",
          paragraphs: [
        ...
        {
          heading: "2. Acuerdo comercial-tecnológico limitado",
          paragraphs: [
        ...
        {
          heading: "3. Fragmentación tecnológica acelerada",
          paragraphs: [
        ...
        {
          heading: "4. Mediación china parcial en Irán",
          paragraphs: [
        ...
        {
          heading: "5. Mayor alineamiento China-Rusia",
          paragraphs: [
        ...
        {
          heading: "6. Trampa de Tucídides contenida, pero no superada",
          paragraphs: [
        ...
        {
          heading: "7. Diplomacia triangular desde Beijing",
          paragraphs: [
