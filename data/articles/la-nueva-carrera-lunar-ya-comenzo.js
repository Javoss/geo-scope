export const articleLaNuevaCarreraLunarYaComenzo = {
  slug: "la-nueva-carrera-lunar-ya-comenzo",
  title: "La nueva carrera lunar ya comenzo",
  subtitle:
    "Estados Unidos y China compiten por la Luna, pero el verdadero objetivo es controlar la proxima infraestructura estratégica del espacio.",
  excerpt:
    "La Luna regreso al centro de la política internacional. Ya no se trata solo de llegar primero, sino de permanecer, construir infraestructura, asegurar posiciones estratégicas y definir las reglas de la futura economía espacial.",
  type: "analysis",
  region: "global",
  sectors: [
  ...
  bodySections: [
    ...
    {
      heading: "La Luna como espacio estratégico",
      paragraphs: [
    ...
    {
      heading: "Artemis y el regreso estadounidense a la Luna",
      paragraphs: [
    ...
    {
      heading: "China y la estrategia de avance gradual",
      paragraphs: [
    ...
    {
      heading: "La carrera no es solo por llegar primero",
      paragraphs: [
    ...
    {
      heading: "El polo sur lunar como punto de friccion",
      paragraphs: [
    ...
    {
      heading: "Estados Unidos, China y la dimension militar",
      paragraphs: [
    ...
    {
      heading: "Qué significa para Europa?",
      paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        {
          heading: "1. Liderazgo estadounidense sostenido",
          paragraphs: [
        ...
        {
          heading: "2. Avance chino acelerado",
          paragraphs: [
        ...
        {
          heading: "3. Cooperacion limitada y competencia controlada",
          paragraphs: [
