export const articleAmericaLatinaYLaCrisisOrganica = {
  slug: "america-latina-y-la-crisis-organica",
  title:
    "América Latina y la crisis orgánica: cuando el Estado ya no logra manejar el conflicto social",
  subtitle:
    "La región no atraviesa solo una sucesión de crisis políticas. En varios países, el problema es más profundo: pérdida de legitimidad institucional, agotamiento económico, fragmentación social y ausencia de proyectos nacionales capaces de ordenar el futuro.",
  excerpt:
    "América Latina vive una etapa de malestar persistente. Protestas sociales, gobiernos débiles, polarización electoral, crisis económicas, inseguridad, corrupción, informalidad laboral y desconfianza institucional aparecen una y otra vez en distintos países de la región.",
  type: "analysis",
...
>>>>>>> develop
  ...
  bodySections: [
    ...
    {
      heading: "Qué es una crisis orgánica",
      paragraphs: [
    ...
    {
      heading: "Crisis orgánica: más allá de izquierda y derecha",
      paragraphs: [
...
<<<<<<< HEAD
        ...
        "Hoy, el MAS ya no controla el poder estatal como lo hizo durante casi dos décadas. Sin embargo, su debilitamiento no ha significado la consolidación automática de una nueva gobernabilidad. El gobierno de Rodrigo Paz, después de casi siete meses en el poder, enfrenta una crisis marcada por protestas, bloqueos, presión social, dificultades económicas, controversias políticas y pérdida de apoyo en sectores que inicialmente acompañaron su llegada al gobierno. Medios internacionales han descrito una Bolivia al borde del estado de excepción, con semanas de protestas, desabastecimiento, bloqueos y tensiones entre el gobierno y sectores sociales que se sienten traicionados por el nuevo rumbo político.",
=======
...
>>>>>>> develop
    ...
    {
      heading: "Perú, Ecuador y la política sin centro",
      paragraphs: [
...
<<<<<<< HEAD
        "Las elecciones presidenciales recientes reflejan esa crisis de representación. Perú llegó a una segunda vuelta marcada por una competencia polarizada entre Keiko Fujimori, candidata conservadora, y Roberto Sánchez, candidato de izquierda vinculado al espacio político de Pedro Castillo. La elección se produjo en un contexto de alta volatilidad institucional, con candidatos en empate estadístico, preocupación por el crimen y un Congreso profundamente fragmentado que ha contribuido a la caída de varios presidentes en los últimos años.",
        "La tendencia peruana confirma un patrón regional: el voto se mueve entre opciones de ruptura, promesas de mano dura, rechazo a las élites tradicionales y búsqueda de representación en sectores rurales, populares o descontentos. Perú se prepara para elegir a su noveno presidente en una década, con el crimen y la desconfianza institucional como temas centrales para los votantes.",
...
>>>>>>> develop
    ...
    {
      heading: "Argentina: ajuste, inflación y ruptura del consenso social",
      paragraphs: [
    ...
    {
      heading: "Brasil: polarización, gobernabilidad y disputa por el rumbo regional",
      paragraphs: [
...
<<<<<<< HEAD
        "La polarización brasileña muestra que una crisis orgánica puede aparecer incluso en una potencia regional con instituciones relativamente fuertes, economía diversificada y gran capacidad diplomática. El problema no es la ausencia de Estado, sino la dificultad de construir consensos estables en una sociedad dividida entre proyectos de país muy distintos.",
        "La elección presidencial de 2026 refleja esa división. Sondeos recientes mostraron a Lula recuperando ventaja frente a Flávio Bolsonaro en una simulación de segunda vuelta, después de semanas de encuestas más estrechas, lo que confirma que Brasil sigue organizado alrededor de una disputa política intensa entre dos grandes campos electorales.",
=======
...
>>>>>>> develop
    ...
    {
      heading: "Colombia y Chile: reformas difíciles y alternancia sin consenso estable",
      paragraphs: [
...
<<<<<<< HEAD
        "Chile vivió una fuerte demanda de transformación social e institucional. Después de un ciclo de gobierno de derecha, el país giró hacia la izquierda con Gabriel Boric, pero posteriormente volvió a inclinarse hacia la derecha con José Antonio Kast. La elección de Kast fue interpretada como el giro más fuerte hacia la derecha desde el retorno a la democracia, impulsado por preocupaciones sobre crimen, migración y agotamiento del ciclo progresista.",
        ...
        "Colombia enfrenta una tensión similar. El país se dirige a una segunda vuelta presidencial entre el senador de izquierda Iván Cepeda y el abogado de derecha Abelardo de la Espriella, después de que ningún candidato alcanzara mayoría suficiente en la primera vuelta. La elección está marcada por el peso de la seguridad, la polarización y el voto anti-incumbente.",
        "La candidatura de De la Espriella refleja una tendencia regional más amplia: outsiders de derecha dura, discurso de orden, crítica a las élites tradicionales y promesas de medidas drásticas contra el crimen. Cepeda busca sostener un espacio de izquierda en un contexto de desgaste del gobierno saliente.",
=======
...
>>>>>>> develop
    ...
    {
      heading: "La economía del malestar",
      paragraphs: [
...
<<<<<<< HEAD
        "La CEPAL ha advertido que la región atraviesa un período prolongado de bajo crecimiento. La Comisión Económica para América Latina y el Caribe proyectó un crecimiento regional de 2,4% para 2025, con una expansión apoyada principalmente en el consumo privado, pero limitada por baja inversión y riesgos externos. El Banco Mundial, por su parte, recortó su estimación de crecimiento para América Latina y el Caribe en 2026 a 2,1%, citando problemas estructurales persistentes, altos costos de financiamiento, débil demanda global, inflación e incertidumbre geopolítica.",
=======
...
>>>>>>> develop
    ...
    {
      heading: "Instituciones débiles y confianza erosionada",
      paragraphs: [
    ...
    {
      heading: "Seguridad, crimen y Estado fragmentado",
      paragraphs: [
    ...
    {
      heading: "Geopolítica de la crisis latinoamericana",
      paragraphs: [
<<<<<<< HEAD
        "La crisis orgánica latinoamericana ocurre en un mundo cada vez más competitivo. Estados Unidos, China, Rusia, Europa y los BRICS observan la región como espacio de recursos naturales, alimentos, minerales críticos, energía, mercados, infraestructura, puertos y posiciones diplomáticas.",
        "América Latina tiene litio, cobre, agua dulce, biodiversidad, gas, petróleo, alimentos y potencial renovable. Pero una región fragmentada negocia desde una posición más débil. Sin estrategia común, los países pueden ser presionados por distintos centros de poder y terminar compitiendo entre sí por inversión, financiamiento o acceso a mercados.",
        "La geopolítica no reemplaza la crisis interna, pero la agrava. Las potencias externas no necesitan crear las fracturas latinoamericanas. Les basta con operar sobre ellas.",
=======
...
>>>>>>> develop
    ...
    {
      heading: "La corrupción como síntoma y acelerador",
      paragraphs: [
    ...
    {
      heading: "¿Qué salida tiene una crisis orgánica?",
      paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        {
          heading: "1. Reorganización democrática",
          paragraphs: [
        ...
        {
          heading: "2. Alternancia sin transformación",
          paragraphs: [
        ...
        {
          heading: "3. Salidas autoritarias o de mano dura",
          paragraphs: [
        ...
        {
          heading: "4. Fragmentación territorial del Estado",
          paragraphs: [
        ...
        {
          heading: "5. Multipolaridad sin estrategia",
          paragraphs: [
        ...
        {
          heading: "6. Nuevo pacto productivo y regional",
          paragraphs: [
