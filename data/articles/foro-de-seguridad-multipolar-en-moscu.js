export const articleForoDeSeguridadMultipolarEnMoscu = {
  slug: "foro-de-seguridad-multipolar-en-moscu",
  title:
    "Foro de Seguridad Multipolar en Moscú: el mundo mayoritario frente a una agenda global en transformación",
  subtitle:
    "El Foro Internacional de Seguridad instaló una agenda alternativa sobre estabilidad, soberanía y orden multipolar, con el mundo mayoritario como interlocutor central.",
  excerpt:
    "El foro celebrado en la región de Moscú consolidó a Rusia como articulador de una conversación alternativa sobre seguridad internacional, con el mundo mayoritario en el centro del debate.",
  type: "analysis",
  region: "global",
  sectors: [
    "defensa-seguridad",
  ...
  bodySections: [
    ...
    {
      heading: "El mensaje de Putin: seguridad interdependiente y cooperación global",
      paragraphs: [
    ...
    {
      heading: "De reunión técnica a plataforma estratégica",
      paragraphs: [
    ...
    {
      heading: "La narrativa rusa: seguridad frente a hegemonía",
      paragraphs: [
    ...
    {
      heading: "El mundo mayoritario y la responsabilidad colectiva por la seguridad",
      paragraphs: [
    ...
    {
      heading: "BRICS, mundo mayoritario y seguridad multipolar",
      paragraphs: [
    ...
    {
      heading: "Inteligencia artificial y seguridad: el nuevo campo de vulnerabilidad",
      paragraphs: [
    ...
    {
      heading: "Fake news, manipulación y guerra cognitiva",
      paragraphs: [
    ...
    {
      heading: "Starlink, OneWeb y la disputa por los sistemas satelitales",
      paragraphs: [
    ...
    {
      heading: "Europa: militarización, migración y crisis de legitimidad",
      paragraphs: [
    ...
    {
      heading: "Propaganda, valores tradicionales y disputa espiritual",
      paragraphs: [
    ...
    {
      heading: "Agua dulce, alimentos y biotecnología: la seguridad material del siglo XXI",
      paragraphs: [
    ...
    {
      heading: "El Sur Global como audiencia principal",
      paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        {
          heading: "1. Consolidación de foros alternativos de seguridad",
          paragraphs: [
        ...
        {
          heading: "2. Seguridad multipolar fragmentada",
          paragraphs: [
        ...
        {
          heading: "3. Diplomacia de seguridad del Sur Global",
          paragraphs: [
        ...
        {
          heading: "4. Ciberseguridad, IA y satélites como nuevos campos de disputa",
          paragraphs: [
        ...
        {
          heading: "5. Seguridad biológica, alimentaria e hídrica como prioridad estratégica",
          paragraphs: [
        ...
        {
          heading: "6. Rusia como articulador con límites",
          paragraphs: [
